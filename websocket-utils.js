...
async function handleMessage(ws, msg) {
    ...
    switch (topic) {
        ...
        case "nameResponse": {
            ...
            for (const client of roomIdClientArray[ws.roomId]) {
            ...
            const clientsAlreadyIn = roomIdClientArray[ws.roomId]
        ...
        case "lastEditorContent": {
            ...
            if (clientId) {
                const client = roomIdClientArray[ws.roomId].find(c => c.clientId === clientId);
            ...
            for (const client of roomIdClientArray[ws.roomId]) {
                ...
                if (client.clientId === ws.clientId) {
                    ws.sendMsg("imageForDiff", await getImageFromHtml(lastEditorContent));
                    continue;
                }
                client.sendMsg("lastEditorContent", { clientId: ws.clientId, lastEditorContent });
            }
